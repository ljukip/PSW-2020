...
namespace PSW_bolnica.Migrations
{
    ...
    [Migration("20210119161246_perscitons")]
    partial class perscitons
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PSW_bolnica.model.Perscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PSW_bolnica.model.User", b =>
                {
                    ...
                    b.HasOne("PSW_bolnica.model.Referral", null)
                        .WithOne("Patient")
                        .HasForeignKey("PSW_bolnica.model.User", "ReferralId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
